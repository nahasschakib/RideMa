...
const VEHICLES_CATEGOEIES = [
  {
    title: "Tous les véhicules",
    desc: "Parcourez la flotte complète",
    Icon: CarTaxiFront,
    tag: "populaire",
  },
  {
    title: "Vélos",
    desc: "trajet rapide et abordable",
    Icon: Bike,
    tag: "Rapide",
  },
  {
    title: "Voitures",
    desc: "voyage confortable en ville",
    Icon: Car,
    tag: "Comfort",
  },
  {
    title: "SUVs",
    desc: "haut de gamme et spacieux",
    Icon: Car,
    tag: "Premium",
  },
  {
    title: "Fourgons",
    desc: "Transports familiaux et de groupe",
    Icon: Bus,
    tag: "Famille",
  },
  {
    title: "Camions",
    desc: "Transport lourd et commercial",
    Icon: Truck,
    tag: "Cargaison",
  },
];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div>
            ...
            <p className="text-zinc-400 text-sm mt-3 font-medium">
              Choisissez le trajet qui correspond à votre voyage
            </p>
          </div>
        ...
        <div className="relative">
          <div
            ...
            {
              VEHICLES_CATEGOEIES.map((category,index)=>{
        ...
        >
         {
           [
            ...
            {num:"10+",label:"Types de véhicule"},
